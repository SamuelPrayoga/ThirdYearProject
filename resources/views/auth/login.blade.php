    ...
    <div class="w-100">
        ...
        <main class="form-signin w-100 m-auto">
            <form method="POST" action="{{ route('auth.login') }}" id="login-form">
                ...
                <center><strong>
                        <h2 class="h3 mb-3 fw-normal">DEL CANTEEN MANAGEMENT SYSTEM INSTITUT TEKNOLOGI DEL</h2>
                    </strong></center>
                ...
                <center>
                    <p class="mt-5 mb-3 text-muted">Pengembangan Sistem Informasi Dilindungi &copy;Institut Teknologi Del
                        2023</p>
                </center>
            </form>
        </main>
