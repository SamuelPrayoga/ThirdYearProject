                                        ...
                                        <td>
                                            @if ($lapor->is_makan == 0)
                                                <button class="btn btn-primary btn-sm" data-toggle="modal"
                                                    data-target="#editModal{{ $index }}"><i class="fas fa-cogs"></i>
                                                    Edit</button>
                                            @elseif ($lapor->is_makan == 1 || $lapor->is_makan == 2)
                                                <button class="btn btn-primary btn-sm" disabled><i class="fas fa-cogs"></i>
                                                    Edit</button>
                                            @endif
                                        </td>
                                    </tr>
                                            ...
                                            <div class="modal-content">
                                                <form id="editForm{{ $index }}"
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel{{ $index }}">Edit
                                                            Data</h5>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><small>Form ini bertujuan untuk mengkonfirmasi Anda
                                                                        apakah melakukan Izin Bermalam atau tidak</small>
                                                                </li>
                                                                <li><small>Sesuaikan tanggal dan waktu keberangkatan pada
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form id="theForm" action="{{ route('home.lapor.makan') }}"
                                                    ...
                                                    @csrf
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="laporModalLabel">Form Lapor Izin Bermalam</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
