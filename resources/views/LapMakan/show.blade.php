...
@section('content')
        ...
        <div class="modal fade" id="editModal{{ $index }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form id="editForm{{ $index }}" action="{{ route('home.IB.edit', ['id' => $lapor->id]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="date" class="form-control" name="tanggal_berangkat"
                                                id="tanggal_berangkat{{ $index }}" placeholder=""
                                                value="{{ $lapor->tanggal_berangkat }}" required>
                                        </div>
                                        <div class="col">
                                            <input type="time" class="form-control" name="jam_berangkat"
                                                id="jam_berangkat{{ $index }}" placeholder=""
                                                value="{{ $lapor->jam_berangkat }}" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="date" class="form-control" name="tanggal_kembali"
                                                id="tanggal_kembali{{ $index }}" placeholder=""
                                                value="{{ $lapor->tanggal_kembali }}" required>
                                        </div>
                                        <div class="col">
                                            <input type="time" class="form-control" name="jam_kembali"
                                                id="jam_kembali{{ $index }}" placeholder=""
    ...
    <!-- Modal Lapor -->
    <div class="modal fade" id="laporModal" tabindex="-1" role="dialog" aria-labelledby="laporModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="theForm" action="{{ route('home.lapor.makan') }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" id="formBerangkat">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="date" class="form-control" name="tanggal_berangkat"
                                            id="tanggal_berangkat" placeholder="" value="" required>
                                    </div>
                                    <div class="col">
                                        <input type="time" class="form-control" name="jam_berangkat"
                                            id="jam_berangkat" placeholder="" value="" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="formKembali">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="date" class="form-control" name="tanggal_kembali"
                                            id="tanggal_kembali" placeholder="" value="" required>
                                    </div>
                                    <div class="col">
                                        <input type="time" class="form-control" name="jam_kembali" id="jam_kembali"
                    ...
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-danger btn-sm" data-dismiss="modal">Reset</button>
                        <button type="submit" class="btn btn-primary btn-sm" id="submitButton">Lapor</button>
                    </div>
                </form>
            </div>
        </div>
