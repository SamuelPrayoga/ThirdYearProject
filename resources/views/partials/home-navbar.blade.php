<nav class="navbar navbar-expand-md navbar-dark py-3" id="bg">
    ...
    <div class="container">
        ...
        &nbsp;
        <a class="navbar-brand" href="/" id="navbarfont" style="text-shadow: 0px 0px 10px rgba(0, 0, 0, 0.8); font-weight: bold;">Kantin Institut Teknologi Del</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav align-items-md-center gap-md-4 py-2 py-md-0" id="navbarfonts">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('home.index') }}" style="text-shadow: 0px 0px 10px rgba(0, 0, 0, 0.6); font-weight: bold;">Beranda <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('home.menumakan') }}" style="text-shadow: 0px 0px 10px rgba(0, 0, 0, 0.6); font-weight: bold;">Menu Makan <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown active">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-shadow: 0px 0px 10px rgba(0, 0, 0, 0.6); font-weight: bold;">
                        Pelaporan
                    </a>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('home.pengumuman') }}" style="text-shadow: 0px 0px 10px rgba(0, 0, 0, 0.6); font-weight: bold;" >Pengumuman</a>
                </li>
